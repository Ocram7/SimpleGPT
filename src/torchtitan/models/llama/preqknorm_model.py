...
class Attention(nn.Module):
    def __init__(self, model_args: ModelArgs):
        ...
        self.q_norm = create_norm(
            model_args.norm_type, model_args.n_heads * self.head_dim, eps=model_args.norm_eps
        )
        self.k_norm = create_norm(
            model_args.norm_type, self.n_kv_heads * self.head_dim, eps=model_args.norm_eps
        )
...
class PreQKNormTransformer(nn.Module):
    def __init__(self, model_args: ModelArgs):
        super().__init__()
    ...
    @classmethod
    def from_model_args(cls, model_args: ModelArgs) -> "PreQKNormTransformer":
